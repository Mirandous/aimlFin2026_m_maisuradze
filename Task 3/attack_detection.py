...
def classify_attack_severity(interval, baseline_mean):
    ...
    amplitude_ratio = interval['peak_requests'] / baseline_mean if baseline_mean > 0 else 0
...
def main():
    ...
    # Load data
    print(f"Loading and processing data from {log_file}...")
    df = load_and_prepare_data(log_file)
